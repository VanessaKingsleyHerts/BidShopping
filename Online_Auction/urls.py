...
urlpatterns = [
    ...
    path('',Home,name="home"),
    path('user_home',Member_Home,name="user_home"),
    path('trainer_home',Member,name="trainer_home"),
    ...
    path('Member_user', Member_User,name="Member_user"),
    path('view_popup', view_popup,name="view_popup"),
    path('all_product2', All_product2,name="all_product2"),
    path('profile', profile, name='profile'),
    path('result', result, name='result'),
    path('search_auctions(<int:pid>)', search_auctions, name='search_auctions'),
    ...
    path('get_latest_auctions/<int:pid>/', get_latest_auctions, name='get_latest_auctions'),
